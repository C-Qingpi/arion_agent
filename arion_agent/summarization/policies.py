...
DEFAULT_PREFETCH_MESSAGES = 100
DEFAULT_TRIGGER_MESSAGES = 130
DEFAULT_TRIGGER_TOKEN_FRACTION = 0.85
DEFAULT_KEEP_MESSAGES = 40
DEFAULT_KEEP_TOKEN_FRACTION = 0.25
DEFAULT_PREFETCH_TOKEN_FRACTION = (
    DEFAULT_TRIGGER_TOKEN_FRACTION * DEFAULT_PREFETCH_MESSAGES / DEFAULT_TRIGGER_MESSAGES
)
